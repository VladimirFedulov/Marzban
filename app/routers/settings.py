...
SETTINGS = [
    ...
    SettingDefinition("JOB_RECORD_REALTIME_BANDWIDTH_INTERVAL", "int", requires_restart=True),
    ...
    SettingDefinition("JOB_RECORD_USER_USAGES_MAX_INSTANCES", "int", requires_restart=True),
    SettingDefinition("JOB_RECORD_NODE_USAGES_MAX_INSTANCES", "int", requires_restart=True),
    SettingDefinition("JOB_RECORD_REALTIME_BANDWIDTH_MAX_INSTANCES", "int", requires_restart=True),
